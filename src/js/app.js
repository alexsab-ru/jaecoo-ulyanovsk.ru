...
cookiecook();
connectForms('https://alexsab.ru/lead/jaecoo/ulyanovsk/', {
...
grecaptcha.ready(function() {
	grecaptcha.execute('6Lepfy4pAAAAAAGHFP655qNe6Bb_BcskklcxajC6', {action: 'jaecoo_ulyanovsk'}).then(function(token) {
